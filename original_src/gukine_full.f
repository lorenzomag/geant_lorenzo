...
c         print*, beammom, alpha, beame, beammass
         ...
         vertex(2) = vertex(2) + offset(2)
         vertex(3) = 0 + offset(3)
         CALL gsvert(vertex,0,0,0,0,nvtx)
         CALL NRAN(rndm,2)
         phi = 2*3.141592654*rndm(1)
         thet = acos(1.0-rndm(2)*0.0003125) ! between 0 and 25 mrad
c         thet = 0.
         cost_r = cos(thet)
         cosp_r = cos(phi)
         ! print*, phi, thet
